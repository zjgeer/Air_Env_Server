###############################################
#OpenWrt Makefile for air_env_server program
##############################################
include $(TOPDIR)/rules.mk
# Name and release number of this package
PKG_NAME:=air_env_server
PKG_RELEASE:=2
...
define Package/air_env_server/description
...
# the air_env_server executable, install it by copying it to the /bin directory on
...
$(eval $(call BuildPackage,air_env_server))
